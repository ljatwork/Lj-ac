...
internal enum Asset {
  ...
  internal static let cam = ImageAsset(name: "cam")
  internal static let camp = ImageAsset(name: "camp")
  internal static let bug = ImageAsset(name: "bug")
  internal static let fish = ImageAsset(name: "fish")
  internal static let fossil = ImageAsset(name: "fossil")
  internal static let seaCreature = ImageAsset(name: "sea-creature")
  internal static let critters = ImageAsset(name: "critters")
  internal static let design = ImageAsset(name: "design")
  internal static let diy = ImageAsset(name: "diy")
  ...
  internal static let searchWhite = ImageAsset(name: "search-white")
  internal static let search = ImageAsset(name: "search")
  internal static let settings = ImageAsset(name: "settings")
  internal static let shop = ImageAsset(name: "shop")
  internal static let songs = ImageAsset(name: "songs")
